...
const Footer = () => {
  return (
    <div>
      <div className="mx-auto w-full bg-[#edf0f0]  text-black">
        <div>
          <div className="footer  px-14 lg:py-16">
            <div>
          <img className="" src="https://i.ibb.co/QjZCmZ2/logo.png" alt="" />
                <img src="" alt="" />
                <h1>Got Question? Call us 24/7</h1>
                <h1>(+1) 84382648364</h1>
                <p>Register now & get you 10%
<br />offer from first order!</p>
            </div>
            <nav>
            ...
            <nav>
              <h6 className="text-base font-bold text-black">My Account</h6>
            ...
            <nav>
              <h6 className="text-base font-bold text-black">Customer Service</h6>
            ...
            <nav>
              <h6 className="text-base font-bold text-black">Download app</h6>
        <div className="flex md:flex-col lg:flex-row"> 
          <img src="https://i.ibb.co/PZHPrcn/image.png" className="w-36 " alt="" />
           <img src="https://i.ibb.co/0nSTshq/image.png" className="w-36" alt="" />
    ...
    <div className="grid grid-flow-col gap-4">
      ...
      <a><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" className="fill-current"><path d="M9 8h-3v4h3v12h5v-12h3.642l.358-4h-4v-1.667c0-.955.192-1.333 1.115-1.333h2.885v-5h-3.808c-3.596 0-5.192 1.583-5.192 4.615v3.385z"></path></svg></a>
          ...
          {/* copy right */}
          <footer className="footer  py-4 border-t bg-[#DDDFDF] text-black lg:px-14">
            ...
            <nav className="md:place-self-center md:justify-self-end">
              <div className="grid grid-flow-col gap-4">
                ...
                <div className="flex gap-4 ">
                  ...
                  <img
                    className="h-6"
                    src="https://shoplineimg.com/assets/footer/card_linepay.png"
                  />
                </div>
              </div>
            </nav>
